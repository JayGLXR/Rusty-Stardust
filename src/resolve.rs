...
/// Finds a module by its hash in the PEB's loaded module list
pub unsafe fn module(library_hash: u32) -> usize {
    ...
    // Use the fixed range_head_list macro instead of manual iteration
...
/// Finds an API function by its hash in the specified module
pub unsafe fn _api(module_base: usize, symbol_hash: usize) -> usize {
    ...
    let export_dir_rva = (*nt_headers).OptionalHeader.DataDirectory[IMAGE_DIRECTORY_ENTRY_EXPORT].VirtualAddress;
